...
import com.example.kiosk_jnsy.R;
import com.example.kiosk_jnsy.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
          ...
          //  View viewMenu = appCompatActivity.getLayoutInflater().inflate(R.layout.item_menu, null);
